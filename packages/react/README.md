...
**NPM**
`npm i @subwallet_connect/react @subwallet_connect/injected-wallets ethers`

**Yarn**
`yarn add @subwallet_connect/react @subwallet_connect/injected-wallets ethers`

### Add Code

```javascript title="App.js"
import React from 'react'
import { init, useConnectWallet } from '@subwallet_connect/react'
...
```ts
import { Web3OnboardProvider, init } from '@subwallet_connect/react'
import injectedModule from '@subwallet_connect/injected-wallets'
...
The `init` function must be called before any hooks can be used. The `init` function just initializes `web3-onboard` and makes it available for all hooks to use. For reference check out the [initialization docs for `@subwallet_connect/core`](../core/README.md#initialization)
...
```typescript
import { useSetChain } from '@subwallet_connect/react'
...
For full Notification documentation please see [Notify section within the `@subwallet_connect/core` docs](../core/README.md#options)
...
```typescript
import { useNotifications } from '@subwallet_connect/react'
...
```typescript
import { useWallets } from '@subwallet_connect/react'
...
```typescript
import { useAccountCenter } from '@subwallet_connect/react'
...
```typescript
import { useSetLocale } from '@subwallet_connect/react'
